...
map.addSource("itinerary", {
  ...
  data: "https://mapping.withalpaca.com/itinerary/XXX.geojson?accessToken=pk.123",
});
```
...
"itinerary": {
  "type": "geojson",
  "data": "https://mapping.withalpaca.com/itinerary/XXX?accessToken=pk.123"
}
```
...
map.addSource("itinerary", {
  ...
  // Note: Update with your Itinerary ID and accessToken
  url: "https://mapping.withalpaca.com/itinerary/XXX.tilejson?scheme=xyz&accessToken=pk.123",
...
"itinerary": {
  "type": "vector",
  "data": "https://mapping.withalpaca.com/itinerary/XXX.tilejson?scheme=xyz&accessToken=pk.123",
  "scheme": "xyz"
}
```
